...
"[project]/app/api/gateway-bridge/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://example.supabase.co"), process.env.SUPABASE_SERVICE_ROLE_KEY);
...
function getWorkRoom(agent) {
    return AGENT_WORK_ROOM[agent] || 'research';
}
function getTalkRoom(agent) {
    return AGENT_TALK_ROOM[agent] || 'social';
}
...
async function detectDelegation(text) {
    ...
    for (const [agentId, patterns] of Object.entries(DELEGATION_PATTERNS)){
        ...
        if (patterns.some((p)=>p.test(text))) {
            ...
            activeDelegations.set(agentName, {
                startedAt: Date.now(),
                task
            });
...
async function GET() {
    return Response.json({
        ...
        agents: [
            ...new Set(Object.values(AGENT_MAP))
        ],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e83823c0._.js.map