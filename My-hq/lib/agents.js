...
export const AGENTS = {
  echo:     { color: '#4A90D9', icon: '⚙️', label: 'Echo',     role: 'Tech Lead',  avatar: '👨‍💻', order: 1 },
  scout:    { color: '#27AE60', icon: '🎨', label: 'Pixel',    role: 'UI/UX',      avatar: '🖌️', order: 2 },
  quill:    { color: '#8E44AD', icon: '🖥️', label: 'Dash',     role: 'Frontend',   avatar: '⚛️', order: 3 },
  sage:     { color: '#F1C40F', icon: '🧠', label: 'Stack',    role: 'Backend',    avatar: '🔧', order: 4 },
  sentinel: { color: '#E74C3C', icon: '🔍', label: 'Probe',    role: 'QA/Tester',  avatar: '🛡️', order: 5 },
  xalt:     { color: '#E67E22', icon: '🚀', label: 'Ship',     role: 'DevOps',     avatar: '📦', order: 6 },
};
